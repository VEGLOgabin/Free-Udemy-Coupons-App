...
def run_scraper():
    ...
    logging.info("Scraper run completed and database updated.")
...
def schedule_scraper():
    ...
    # Add jobs
    scheduler.add_job(run_scraper, IntervalTrigger(minutes=1), id=job_ids['run_scraper'], replace_existing=True)
